...
## DATA UPDATES
## Can set a date check on data file to determine if re-read is needed
...
tickerorder <- c('SP500', 'QQQ', 'VIX', 'BTC-USD')
...
This is a simple document. I wrote it to provide a focal point for
   class discussions, focusing on information that I hope will be salient
   for students. Comments are welcome. It is licensed under the MIT
   License and [available on Github](https://github.com/rmcd1024/fin-dash)
